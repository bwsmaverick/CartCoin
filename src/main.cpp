...
#if defined(NDEBUG)
# error "Cart cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Cart Signed Message:\n";
            ...
            return DoS(100, error("ConnectBlock() : coinstake pays too much(actual=%d vs calculated=%d)", nStakeReward, nCalculatedStakeReward));
                ...
                if (pindex->nHeight > 25) {
                    ...
                    BOOST_FOREACH(const CTxOut& output, vtx[1].vout) {  
                       ...
                       CTxDestination addrcart2;
                       ExtractDestination(output.scriptPubKey, addrcart2);
                       std::string GetTxAdressFromTransaction = CBitcoinAddress (addrcart2).ToString().c_str();
                        ...
                        if (GetTxAdressFromTransaction == "CUNL15U3ukREz3ZcF4smtcJ9zvZtGjFefA") {
                              ...
                              uint64_t nOutputCart = output.nValue;

                            if (nOutputCart == (nCalculatedStakeReward / 5)) {
...
#ifdef ENABLE_WALLET
// Cart: attempt to generate suitable proof-of-stake
